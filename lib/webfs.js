...
(function() {
    ...
    this.writeFile = function(filename, buffer, encoding, callback, progress) {
        var _self = this,
            data;
    ...
    this.read = function(fd, buffer, offset, length, position, callback, progress) {
        var _self = this,
            data;
    ...
    this.readFile = function(filename, encoding, callback, position) {
        var _self = this;
