...
var WebFS = (function() {
    ...
    WebFS.prototype.errorHandler = function(error) {
        ...
        switch(error.code) {
            ...
            case this.TYPE_MISMATCH_ERR:
                msg = "Incorrect file operation on file or directory.";
                break;
            case this.PATH_EXISTS_ERR:
                msg = "This path already exists"
                break;
        }
     ...
     * Stub function for nodejs compatibility
     */
    WebFS.prototype.stat =
    WebFS.prototype.lstat =
    WebFS.prototyoe.fstat = function(path, callback) {
        var _self = this;
        ...
        this.open(path, function(error, fileHandler) {
            if (error && error == "Incorrect file operation on file or directory.") {
     ...
     */
    WebFS.prototype.writeFile = function(filename, data, encoding_, callback_) {
        var _self = this;
     ...
     * @param {Function} callback Callback function
     */
    WebFS.prototype.readFile = function(filename, encoding_, callback_) {
        var _self = this;
